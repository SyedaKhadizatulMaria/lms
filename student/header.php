...
$data = mysqli_query($conn,"SELECT * FROM `students` WHERE `email` = '$student_login' OR `username` = '$student_login'");
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <!--UI ELEMENTENTS-->
                                <li class="<?= $page == 'checkout-books.php' ? 'active-item': ''?>"><a href="checkout-books.php"><i class="fa fa-exchange" aria-hidden="true"></i><span>Checkout</span></a></li>
